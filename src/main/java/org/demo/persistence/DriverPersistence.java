...
/**
 * Persistence Interface for DriverRecord.
 */
public interface DriverPersistence { 
	 ...
	 * @return entity
	 */
	DriverRecord findById( Integer id  ) ;

	/**
	 * Finds all entities.
	 * @return all entities
	 */
	List<DriverRecord> findAll();
	 ...
	 * @return entity
	 */
	DriverRecord save(DriverRecord entity);
	 ...
	 */
	boolean update(DriverRecord entity);
	 ...
	 * @return
	 */
	DriverRecord create(DriverRecord entity);
	 ...
	 * @return true if the entity has been deleted, false if not found and not deleted
	 */
	boolean delete( DriverRecord entity );
